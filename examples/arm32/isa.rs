...
use isa_minimization::isa_specification::{
    ArchitecturalRegister, BranchOffset, DerivedValue, Instruction, InstructionField,
    InstructionForm, Predicate, and, bit_eq, c, field_eq, field_in,
};
...
pub fn b() -> Instruction {
    with_effects(
        Instruction::new("b", 32)
            .branch_instruction(BranchOffset::PCRelative(add(
                constant(8, 32),
                branch_pc_relative_offset(),
            )))
            .form(
                InstructionForm::new("base")
